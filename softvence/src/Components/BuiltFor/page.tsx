  ...
  return (
    <div className="lg:mt-44">
      ...
      <div className="lg:pt-2" style={{
        backgroundImage: "url('/images/Frame 2147227453.png'), url('/images/Vector 7625.png'), url('/images/Vector 7626.png')",
        backgroundRepeat: "no-repeat, no-repeat, no-repeat",
        backgroundPosition: "20% top, 35% top, right top",
        ...
        <div
          style={{
            backgroundImage:
              "url('/images/Ellipse 24.png'), url('/images/Ellipse 30.png')",
            backgroundRepeat: "no-repeat, no-repeat",
            backgroundPosition: "top left, left",
            backgroundSize: "auto, 100%",
          }}
        >
          <section className="w-full md:max-w-[1440px] md:px-[120px] grid grid-cols-1 md:grid-cols-2 items-center justify-between lg:mt-24 p-5">
            <div>
        ...
        >
          <section className="w-full md:max-w-[1440px] md:px-[120px] grid grid-cols-1 md:grid-cols-2 items-center justify-center lg:mt-10 p-5 ">
            <motion.div
              initial={{ x: 100, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              transition={{ type: "spring", stiffness: 80 }}
